...
void NPSDetectorConstruction::ConstructSDandField()
{
  ...
  NPSCalorimeterSD* npsSD = new NPSCalorimeterSD("CalorimeterSD",
						 "CalorimeterHitsCollection");

  // Register the messenger for deleting
  G4AutoDelete::Register(npsSD);
  
  //  SetSensitiveDetector("CalorimeterAssembly", npsSD, true);
  SetSensitiveDetector("Block", npsSD, true);
