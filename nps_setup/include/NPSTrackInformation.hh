...
#ifndef NPSTrackInformation_h
#define NPSTrackInformation_h 1
...
class NPSTrackInformation : public G4VUserTrackInformation {

public:

  NPSTrackInformation();
  NPSTrackInformation(const G4Track* aTrack);
  NPSTrackInformation(const NPSTrackInformation* aTrackInfo);
  virtual ~NPSTrackInformation();
   
  inline void *operator new(size_t);
  inline void operator delete(void *aTrackInfo);

  NPSTrackInformation& operator =(const NPSTrackInformation& right);
...
extern G4ThreadLocal G4Allocator<NPSTrackInformation> *
aTrackInformationAllocator;
//extern  G4Allocator<AmagnetTrackInformation> aTrackInformationAllocator;

inline void* NPSTrackInformation::operator new(size_t)
{
  if(!aTrackInformationAllocator)
    aTrackInformationAllocator = new G4Allocator<NPSTrackInformation>;
  return (void*)aTrackInformationAllocator->MallocSingle();
}

inline void NPSTrackInformation::operator delete(void *aTrackInfo)
{ aTrackInformationAllocator->FreeSingle((NPSTrackInformation*)aTrackInfo);}
